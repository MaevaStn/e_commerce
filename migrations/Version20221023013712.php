 ...
 */
final class Version20221023013712 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE article (id INT AUTO_INCREMENT NOT NULL, categorie_id INT NOT NULL, nom_article VARCHAR(80) DEFAULT NULL, image_article VARCHAR(255) DEFAULT NULL, prix_article DOUBLE PRECISION DEFAULT NULL, description_article VARCHAR(255) DEFAULT NULL, image_file_name VARCHAR(255) NOT NULL, INDEX IDX_23A0E66BCF5E72D (categorie_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
